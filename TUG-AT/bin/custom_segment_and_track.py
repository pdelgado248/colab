...
def get_dataset_parameters(dataset_name):
    normalization_consideration_factors = {'Nantes': (0.001, 0.001)}
    image_gaussian_blur_sigma = {'Nantes': 1.0}
    additional_scale = {'Nantes': [1, 1]}
...
def get_instance_image_creator_parameters(dataset_name):
    bandwidth = {'Nantes': 0.1}
    min_label_size = {'Nantes': 50}
    coord_factors = {'Nantes': 0.005}
...
def get_instance_tracker_parameters(dataset_name):
    image_ignore_border = {'Nantes': (25,25)}
    parent_search_dilation_size = {'Nantes': 3}
    max_parent_search_frames = {'Nantes': 8}
    max_merge_search_frames = {'Nantes': 10}
    min_track_length = {'Nantes': 2}
...
def image_sizes_for_dataset_name(dataset_name):
    train_image_size = {'Nantes': [512,512]}

    test_image_size = {'Nantes': [512,512]}  
